...
function Technology() {
  ...
  useEffect(() => {
    const url = `https://newsapi.org/v2/top-headlines?country=us&category=general&apiKey=a389ee0dc62541acbb76ad0c18db12bd&page=${currentPage}&pageSize=${pageSize}`;
  ...
  return (
    <>
      ...
      <div style={{ marginBottom: 50 }}>
        ...
        <p style={{ fontSize: 18, color: 'black', fontWeight: 'bolder' }}>Teknoloji</p>
      </div>
